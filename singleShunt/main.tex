...
\item \textbf{Switching-state phase shift} redistributes the pattern within the period to enlarge measurable regions with reduced distortion penalty \cite{Gu2011}.
